...
var ANIMATION_OPTIONS = [{
  ...
  label: __('Random Reveal', 'frontblocks'),
  value: 'random-reveal'
}, {
  label: __('Flicker', 'frontblocks'),
  value: 'flicker'
}, {
  label: __('Block Reveal', 'frontblocks'),
  value: 'block-reveal'
}, {
  label: __('Tracking Expand', 'frontblocks'),
  value: 'tracking-expand'
}, {
  label: __('Terminal Type', 'frontblocks'),
  value: 'terminal-type'
}, {
  label: __('Solid Outline', 'frontblocks'),
  value: 'solid-outline'
}, {
  label: __('Glitch RGB', 'frontblocks'),
  value: 'glitch-rgb'
}, {
  label: __('Water Drop', 'frontblocks'),
  value: 'water-drop'
}, {
  label: __('Pulse Neon', 'frontblocks'),
  value: 'pulse-neon'
}, {
  label: __('Shadow Pop', 'frontblocks'),
  value: 'shadow-pop'
}, {
...
var ANIMATION_PREVIEWS = {
  ...
  'shadow-pop': {
    ...
    render: function ShadowPopRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
      ...
      return /*#__PURE__*/React.createElement(Tag, {
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblShadowPop ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'pulse-neon': {
    duration: function duration(text) {
      return (text.length * 0.05 + 1.5) * 1000;
    },
    render: function PulseNeonRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
        animKey = _ref0.animKey;
      var CHAR_DURATION = 1.5;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
        key: animKey
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblPulseNeon ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'water-drop': {
    ...
    render: function WaterDropRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
      ...
      return /*#__PURE__*/React.createElement(Tag, {
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblWaterDrop ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'glitch-rgb': {
    ...
    render: function GlitchRGBRender(_ref10) {
      ...
      return /*#__PURE__*/React.createElement(Tag, {
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblGlitchRGB ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'solid-outline': {
    ...
    render: function SolidOutlineRender(_ref11) {
      ...
      var CHAR_DURATION = 0.8;
      var CHAR_DELAY = 0.05;
      var strokeColor = style.color || 'currentColor';
      return /*#__PURE__*/React.createElement(Tag, {
        style: _objectSpread(_objectSpread({}, style), {}, {
          '--frbl-stroke-color': strokeColor
        }),
        key: animKey
      }, text.split('').map(function (char, i) {
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblSolidOutline ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'terminal-type': {
    ...
    render: function TerminalTypeRender(_ref12) {
  ...
  'tracking-expand': {
    ...
    render: function TrackingExpandRender(_ref13) {
  ...
  'block-reveal': {
    ...
    render: function BlockRevealRender(_ref14) {
  ...
  'flicker': {
    duration: function duration(text) {
      return (text.length * 0.05 + 1.2) * 1000;
    },
    render: function FlickerRender(_ref15) {
      var text = _ref15.text,
        style = _ref15.style,
        Tag = _ref15.Tag,
        animKey = _ref15.animKey;
      var CHAR_DURATION = 1.2;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
        key: animKey
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblFlicker ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'random-reveal': {
    duration: function duration(text) {
      return text.replace(/ /g, '').length * 50;
    },
    render: function RandomRevealRender(_ref16) {
      ...
      useEffect(function () {
        ...
        el.innerHTML = '';
        var chars = text.split('');
        var indices = chars.map(function (_, i) {
          return i;
        }).sort(function () {
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref17) {
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref18) {
      ...
      return /*#__PURE__*/React.createElement(Tag, {
        ...
        return /*#__PURE__*/React.createElement("span", {
          ...
          style: {
            ...
            whiteSpace: 'pre',
            opacity: 0,
            animation: "frblRollIn ".concat(CHAR_DURATION, "s forwards"),
            animationDelay: "".concat(i * CHAR_DELAY, "s")
          }
        }, char);
      }));
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref19) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref20) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref21) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref22) {
      var text = _ref22.text,
        style = _ref22.style,
        Tag = _ref22.Tag,
        animKey = _ref22.animKey;
      var CHAR_DURATION = 0.8;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
  ...
  'flash': {
    ...
    render: function FlashRender(_ref23) {
      var text = _ref23.text,
        style = _ref23.style,
        Tag = _ref23.Tag,
        animKey = _ref23.animKey;
      var CHAR_DURATION = 1;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref24) {
      var text = _ref24.text,
        style = _ref24.style,
        Tag = _ref24.Tag,
        animKey = _ref24.animKey;
      var CHAR_DURATION = 0.5;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
  ...
  'swing': {
    ...
    render: function SwingRender(_ref25) {
      var text = _ref25.text,
        style = _ref25.style,
        Tag = _ref25.Tag,
        animKey = _ref25.animKey;
      var CHAR_DURATION = 0.8;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: style,
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref26) {
      var text = _ref26.text,
        style = _ref26.style,
        Tag = _ref26.Tag,
        animKey = _ref26.animKey;
      var CHAR_DURATION = 0.6;
      var CHAR_DELAY = 0.06;
      return /*#__PURE__*/React.createElement(Tag, {
        style: _objectSpread(_objectSpread({}, style), {}, {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref27) {
      var text = _ref27.text,
        style = _ref27.style,
        Tag = _ref27.Tag,
        animKey = _ref27.animKey;
      var CHAR_DURATION = 0.5;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: _objectSpread(_objectSpread({}, style), {}, {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref28) {
      var text = _ref28.text,
        style = _ref28.style,
        Tag = _ref28.Tag,
        animKey = _ref28.animKey;
      var CHAR_DURATION = 0.5;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: _objectSpread(_objectSpread({}, style), {}, {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref29) {
      var text = _ref29.text,
        style = _ref29.style,
        Tag = _ref29.Tag,
        animKey = _ref29.animKey;
      var CHAR_DURATION = 0.5;
      var CHAR_DELAY = 0.05;
      return /*#__PURE__*/React.createElement(Tag, {
        style: _objectSpread(_objectSpread({}, style), {}, {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref30) {
      var text = _ref30.text,
        style = _ref30.style,
        Tag = _ref30.Tag,
        animKey = _ref30.animKey;
      var _wp$element5 = wp.element,
        useEffect = _wp$element5.useEffect,
        useRef = _wp$element5.useRef;
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref31) {
      var text = _ref31.text,
        style = _ref31.style,
        Tag = _ref31.Tag,
        animKey = _ref31.animKey;
      var _wp$element6 = wp.element,
        useEffect = _wp$element6.useEffect,
        useRef = _wp$element6.useRef;
      var containerRef = useRef(null);
      useEffect(function () {
        var el = containerRef.current;
        if (!el) return;
...
function AnimationPreview(_ref32) {
  var animationType = _ref32.animationType,
    text = _ref32.text,
    style = _ref32.style,
    Tag = _ref32.Tag;
