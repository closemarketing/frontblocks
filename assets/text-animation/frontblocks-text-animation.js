...
var ANIMATION_PREVIEWS = {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'flash': {
    ...
    render: function FlashRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref10) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref11) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref12) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref13) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref14) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref15) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref16) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref17) {
...
function AnimationPreview(_ref18) {
