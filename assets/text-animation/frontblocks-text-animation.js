...
var ANIMATION_PREVIEWS = {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref10) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref11) {
...
function AnimationPreview(_ref12) {
  var animationType = _ref12.animationType,
    text = _ref12.text,
    style = _ref12.style,
    Tag = _ref12.Tag;
