...
var ANIMATION_PREVIEWS = {
  ...
  'pulse-neon': {
    ...
    render: function PulseNeonRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'water-drop': {
    ...
    render: function WaterDropRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'glitch-rgb': {
    ...
    render: function GlitchRGBRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'solid-outline': {
    ...
    render: function SolidOutlineRender(_ref10) {
  ...
  'terminal-type': {
    ...
    render: function TerminalTypeRender(_ref11) {
  ...
  'tracking-expand': {
    ...
    render: function TrackingExpandRender(_ref12) {
  ...
  'block-reveal': {
    ...
    render: function BlockRevealRender(_ref13) {
  ...
  'flicker': {
    ...
    render: function FlickerRender(_ref14) {
  ...
  'random-reveal': {
    ...
    render: function RandomRevealRender(_ref15) {
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref16) {
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref17) {
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref18) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref19) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref20) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref21) {
  ...
  'flash': {
    ...
    render: function FlashRender(_ref22) {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref23) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref24) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref25) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref26) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref27) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref28) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref29) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref30) {
...
function AnimationPreview(_ref31) {
  var animationType = _ref31.animationType,
    text = _ref31.text,
    style = _ref31.style,
    Tag = _ref31.Tag;
