...
var ANIMATION_PREVIEWS = {
  ...
  'solid-outline': {
    ...
    render: function SolidOutlineRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'terminal-type': {
    ...
    render: function TerminalTypeRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'tracking-expand': {
    ...
    render: function TrackingExpandRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'block-reveal': {
    ...
    render: function BlockRevealRender(_ref10) {
  ...
  'flicker': {
    ...
    render: function FlickerRender(_ref11) {
  ...
  'random-reveal': {
    ...
    render: function RandomRevealRender(_ref12) {
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref13) {
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref14) {
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref15) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref16) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref17) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref18) {
  ...
  'flash': {
    ...
    render: function FlashRender(_ref19) {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref20) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref21) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref22) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref23) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref24) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref25) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref26) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref27) {
...
function AnimationPreview(_ref28) {
  var animationType = _ref28.animationType,
    text = _ref28.text,
    style = _ref28.style,
    Tag = _ref28.Tag;
