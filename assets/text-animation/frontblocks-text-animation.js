...
var ANIMATION_PREVIEWS = {
  ...
  'water-drop': {
    ...
    render: function WaterDropRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'glitch-rgb': {
    ...
    render: function GlitchRGBRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'solid-outline': {
    ...
    render: function SolidOutlineRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'terminal-type': {
    ...
    render: function TerminalTypeRender(_ref10) {
  ...
  'tracking-expand': {
    ...
    render: function TrackingExpandRender(_ref11) {
  ...
  'block-reveal': {
    ...
    render: function BlockRevealRender(_ref12) {
  ...
  'flicker': {
    ...
    render: function FlickerRender(_ref13) {
  ...
  'random-reveal': {
    ...
    render: function RandomRevealRender(_ref14) {
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref15) {
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref16) {
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref17) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref18) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref19) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref20) {
  ...
  'flash': {
    ...
    render: function FlashRender(_ref21) {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref22) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref23) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref24) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref25) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref26) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref27) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref28) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref29) {
...
function AnimationPreview(_ref30) {
  var animationType = _ref30.animationType,
    text = _ref30.text,
    style = _ref30.style,
    Tag = _ref30.Tag;
