...
var ANIMATION_PREVIEWS = {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'swing': {
    ...
    render: function SwingRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref10) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref11) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref12) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref13) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref14) {
...
function AnimationPreview(_ref15) {
  var animationType = _ref15.animationType,
    text = _ref15.text,
    style = _ref15.style,
    Tag = _ref15.Tag;
