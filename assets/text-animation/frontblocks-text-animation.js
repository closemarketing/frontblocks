...
var ANIMATION_PREVIEWS = {
  ...
  'glitch-rgb': {
    ...
    render: function GlitchRGBRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'solid-outline': {
    ...
    render: function SolidOutlineRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'terminal-type': {
    ...
    render: function TerminalTypeRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'tracking-expand': {
    ...
    render: function TrackingExpandRender(_ref10) {
  ...
  'block-reveal': {
    ...
    render: function BlockRevealRender(_ref11) {
  ...
  'flicker': {
    ...
    render: function FlickerRender(_ref12) {
  ...
  'random-reveal': {
    ...
    render: function RandomRevealRender(_ref13) {
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref14) {
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref15) {
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref16) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref17) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref18) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref19) {
  ...
  'flash': {
    ...
    render: function FlashRender(_ref20) {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref21) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref22) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref23) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref24) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref25) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref26) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref27) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref28) {
...
function AnimationPreview(_ref29) {
  var animationType = _ref29.animationType,
    text = _ref29.text,
    style = _ref29.style,
    Tag = _ref29.Tag;
