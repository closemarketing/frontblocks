...
var ANIMATION_PREVIEWS = {
  ...
  'random-reveal': {
    ...
    render: function RandomRevealRender(_ref9) {
      var text = _ref9.text,
        style = _ref9.style,
        Tag = _ref9.Tag,
  ...
  'glitch': {
    ...
    render: function GlitchRender(_ref0) {
      var text = _ref0.text,
        style = _ref0.style,
        Tag = _ref0.Tag,
  ...
  'roll-in': {
    ...
    render: function RollInRender(_ref1) {
      var text = _ref1.text,
        style = _ref1.style,
        Tag = _ref1.Tag,
  ...
  'squeeze': {
    ...
    render: function SqueezeRender(_ref10) {
  ...
  'stretch': {
    ...
    render: function StretchRender(_ref11) {
  ...
  'wave': {
    ...
    render: function WaveRender(_ref12) {
  ...
  'rubber-band': {
    ...
    render: function RubberBandRender(_ref13) {
  ...
  'flash': {
    ...
    render: function FlashRender(_ref14) {
  ...
  'pulse': {
    ...
    render: function PulseRender(_ref15) {
  ...
  'swing': {
    ...
    render: function SwingRender(_ref16) {
  ...
  'drop-in': {
    ...
    render: function DropInRender(_ref17) {
  ...
  'slide-right': {
    ...
    render: function SlideRightRender(_ref18) {
  ...
  'slide-left': {
    ...
    render: function SlideLeftRender(_ref19) {
  ...
  'slide-down': {
    ...
    render: function SlideDownRender(_ref20) {
  ...
  'shuffle-text': {
    ...
    render: function ShuffleTextRender(_ref21) {
  ...
  'typewriter': {
    ...
    render: function TypewriterRender(_ref22) {
...
function AnimationPreview(_ref23) {
  var animationType = _ref23.animationType,
    text = _ref23.text,
    style = _ref23.style,
    Tag = _ref23.Tag;
